...
highlight AArch64Comment        guifg=#7C7695 ctermfg=103
highlight AArch64Directive      guifg=#3FC6DE ctermfg=81
highlight AArch64Label          guifg=#F38BA8 ctermfg=211 gui=bold cterm=bold
highlight AArch64Macro          guifg=#F5A97F ctermfg=216
highlight AArch64Mnemonic       guifg=#3FC6DE ctermfg=81
highlight AArch64Modifier       guifg=#B39DDB ctermfg=141
highlight AArch64Number         guifg=#F6C177 ctermfg=222
highlight AArch64Operator       guifg=#C8C1E6 ctermfg=189
highlight AArch64Register       guifg=#9CCFD8 ctermfg=152 gui=italic cterm=italic
highlight AArch64PState         guifg=#9CCFD8 ctermfg=152 gui=italic cterm=italic
highlight AArch64SystemRegister guifg=#9CCFD8 ctermfg=152 gui=italic cterm=italic
highlight AArch64Type           guifg=#F5A97F ctermfg=216
highlight AArch64TODO           guifg=#1F1D2E guibg=#F6C177 ctermfg=235 ctermbg=222 gui=bold cterm=bold
highlight AArch64String         guifg=#F6C177 ctermfg=222
